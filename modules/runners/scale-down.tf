...
resource "aws_lambda_function" "scale_down" {
  ...
  function_name     = "${local.resource_name}-scale-down"
...
resource "aws_cloudwatch_event_rule" "scale_down" {
  name                = "${local.resource_name}-scale-down-rule"
...
resource "aws_iam_role" "scale_down" {
  name                 = "${local.resource_name}-action-scale-down-lambda-role"
...
resource "aws_iam_role_policy" "scale_down" {
  name = "${local.resource_name}-lambda-scale-down-policy"
...
resource "aws_iam_role_policy" "scale_down_logging" {
  name = "${local.resource_name}-lambda-logging"
  role = aws_iam_role.scale_down.name
