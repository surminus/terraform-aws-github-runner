resource "aws_lambda_function" "scale_up" {
  ...
  function_name                  = "${local.resource_name}-scale-up"
...
resource "aws_iam_role" "scale_up" {
  name                 = "${local.resource_name}-action-scale-up-lambda-role"
...
resource "aws_iam_role_policy" "scale_up" {
  name = "${local.resource_name}-lambda-scale-up-policy"
...
resource "aws_iam_role_policy" "service_linked_role" {
  ...
  name   = "${local.resource_name}-service_linked_role"
  role   = aws_iam_role.scale_up.name
