resource "aws_ssm_parameter" "github_app_id" {
  name   = "/actions_runner/${local.resource_name}/github_app_id"
  type   = "SecureString"
...
resource "aws_ssm_parameter" "github_app_key_base64" {
  name   = "/actions_runner/${local.resource_name}/github_app_key_base64"
  type   = "SecureString"
...
resource "aws_ssm_parameter" "github_app_webhook_secret" {
  name   = "/actions_runner/${local.resource_name}/github_app_webhook_secret"
  type   = "SecureString"
